        ...
        <div class="contentsBlock blockWhite">
          <div class="linkList">
              ...
              <ul class="clearfix">
                  ...
                  <li><a href="#"><img src="/static/img/icon/set/alarm-1.png" alt=""><span>Link Name</span></a></li>
                  <li><a href="#"><img src="/static/img/icon/set/back.png" alt=""><span>Link Name</span></a></li>
                  <li><a href="#"><img src="/static/img/icon/set/cloud-computing-4.png" alt=""><span>Link Name</span></a></li>
                  <li><a href="#"><img src="/static/img/icon/set/app.png" alt=""><span>Link Name</span></a></li>
                  ...
                  <li><a href="#"><img src="/static/img/icon/set/placeholder-2.png" alt=""><span>Link Name</span></a></li>
                  <li><a href="#"><img src="/static/img/icon/set/folder-3.png" alt=""><span>Link Name</span></a></li>
                  <li><a href="#"><img src="/static/img/icon/set/repeat-1.png" alt=""><span>Link Name</span></a></li>
                  <li><a href="#"><img src="/static/img/icon/set/user-6.png" alt=""><span>Link Name</span></a></li>
                  <li><a href="#"><img src="/static/img/icon/set/worldwide-1.png" alt=""><span>Link Name</span></a></li>
              </ul>    
          </div>    
        </div>
    </div>
